...
Один инструмент вместо четырёх (f680-api / f680-pf / f680-dhcp /
f680-net). Запуск:
...
старые команды-обёртки f680-api / f680-pf / f680-dhcp / f680-net
по-прежнему работают, но deprecated — используйте `f680`.
"""
